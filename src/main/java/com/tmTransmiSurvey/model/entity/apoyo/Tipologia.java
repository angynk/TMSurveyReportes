...
public class Tipologia {
    ...
    private Set<FovCodigos> tipologiaRecords= new HashSet<FovCodigos>(0);
    ...
    public Set<FovCodigos> getTipologiaRecords() {
        return tipologiaRecords;
    }

    public void setTipologiaRecords(Set<FovCodigos> tipologiaRecords) {
